      ...
      <div className="flex items-center gap-1.5 flex-nowrap">
        {selectedTagIds.length > 0 && (
          <button
            ...
            className="flex-shrink-0 inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold text-rose-500 bg-rose-500/10 border border-rose-500/20 hover:bg-rose-500/20 transition-colors"
          >
            <X className="w-3 h-3" />
        ...
        {tags.map((tag) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold border transition-all duration-150',
                isSelected
