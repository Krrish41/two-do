      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute left-0 right-0 top-full mt-1.5 z-50 min-w-[180px] max-h-60 overflow-y-auto glass-panel-elevated p-1.5 rounded-2xl shadow-2xl border border-glass-border flex flex-col gap-0.5"
          >
            {options.map((opt) => {
