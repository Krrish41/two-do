      ...
      <button
        ...
        className={cn(
          ...
          subtask.is_completed
            ...
            : 'border-ink-muted bg-surface hover:border-lavender-accent'
        )}
      >
    ...
    <AnimatePresence>
      {Boolean(selectedTaskId) && (
        <div className="fixed inset-0 z-50 overflow-hidden flex items-end md:items-stretch md:justify-end">
          ...
          {/* Responsive Sheet: Bottom Sheet on Mobile (<768px), Right Slide-Over on Desktop (>=768px) */}
          <motion.div
            initial={{ y: '100%', x: 0 }}
            animate={{ y: 0, x: 0 }}
            exit={{ y: '100%', x: 0 }}
          ...
          >
            <div className="flex flex-col gap-5 pb-6">
              ...
              <div className="p-3.5 rounded-2xl glass-panel-subtle flex flex-col gap-2">
                <label className="text-xs font-semibold text-ink-muted flex items-center gap-1.5">
                  <UserCheck className="w-3.5 h-3.5 text-lavender-accent" />
                  Assignee
                </label>
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected
                            ? 'bg-surface-elevated shadow-sm border-lavender-accent ring-1 ring-lavender-accent/30 font-bold'
                            : 'bg-surface border-glass-border-subtle hover:bg-surface-elevated'
                        )}
                      >
                        <div
